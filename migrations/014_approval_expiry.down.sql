...
ALTER TABLE mandate.approval_assignments
  DROP CONSTRAINT IF EXISTS approval_assignments_terminal_shape_check,
  ...
  ADD CONSTRAINT approval_assignments_check CHECK (
...
ALTER TABLE mandate.approvals
  DROP CONSTRAINT IF EXISTS approvals_expiry_evidence_shape,
  DROP COLUMN IF EXISTS expiration_request_id,
  DROP COLUMN IF EXISTS expiration_reason,
  DROP COLUMN IF EXISTS expired_at;

DELETE FROM mandate.schema_migrations
WHERE version = '014_approval_expiry';
