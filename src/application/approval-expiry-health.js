...
export function renderApprovalExpiryMetrics(expiryProcess, now = new Date()) {
  ...
  return [
    ...
    '# HELP mandate_approval_expiry_expired_total Pending approvals materialized as expired.',
    ...
    '# HELP mandate_approval_expiry_backlog_pending_expiring Pending approvals with a deadline in worker scope.',
    '# TYPE mandate_approval_expiry_backlog_pending_expiring gauge',
    `mandate_approval_expiry_backlog_pending_expiring ${finite(snapshot.backlogPendingExpiring)}`,
    '# HELP mandate_approval_expiry_backlog_due Pending approvals whose deadline has elapsed.',
    '# TYPE mandate_approval_expiry_backlog_due gauge',
    `mandate_approval_expiry_backlog_due ${finite(snapshot.backlogDue)}`,
    '# HELP mandate_approval_expiry_oldest_overdue_seconds Age of the oldest overdue pending approval.',
